...
- **Dependency/closure growth.** iced adds a winit/wgpu/Wayland/Vulkan/fontconfig
  tree the current zero-`buildInputs` crane build and the harbor-rs dev shell do
