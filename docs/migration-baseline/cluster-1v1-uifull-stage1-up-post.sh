...
exec /nix/store/yfcsg8qggil8bn0g804agzla9jyxf4g5-cluster-ctl-0.1.0/bin/cluster-ctl --vm-count 1  --cluster 1v1-uifull-stage1 up --runners-dir /nix/store/sd4pdbhsprx1ihj0487a6dgvpraffvkf-cluster-vm-runners-uifull-stage1 "$@"
